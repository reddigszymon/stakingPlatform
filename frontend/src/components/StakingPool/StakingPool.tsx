...
function StakingPool() {
  return (
    <div className="flex w-[90%] max-w-[600px] lg:max-w-[700px] flex-col gap-[5px] font-bold z-[-1] md:z-[10] ">
      ...
      <div className="w-full h-[180px] lg:h-[230px] rounded-2xl bg-[#FBEBF7] p-[15px] lg:p-[20px] flex flex-col gap-[10px] items-center justify-between">
        <div className="w-full flex justify-between items-center">
          ...
          <button className="bg-[#FF007A] text-[#FF007A] text-opacity-[90%] cursor-pointer bg-opacity-[25%] py-[10px] lg:py-[15px] px-[20px] lg:px-[25px] rounded-2xl font-bold text-[18px]">
            Deposit
          </button>
        </div>
